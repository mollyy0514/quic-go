...
// // NewBbrSentPacketHandler creates a new sentBbrPacketHandler
// func NewBbrSentPacketHandler(
// 	initialPN protocol.PacketNumber,
// 	rttStats *utils.RTTStats,
// 	pers protocol.Perspective,
// 	tracer *logging.ConnectionTracer,
...
// 	if h.logger.Debug() {
// 		for p := max(0, pnSpace.largestSent+1); p < packet.PacketNumber; p++ {
...
// 		case *wire.AckFrame:
// 			packet.LargestAcked = frame.LargestAcked()
// 		}
// 	}
